...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool loading, bool error, bool success, List<News> news});
}
...
class _$HomeStateImpl extends _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(loading: $loading, error: $error, success: $success, news: $news)';
  }
...
abstract class _HomeState extends HomeState {
  const factory _HomeState(
      ...
      final bool error,
      final bool success,
      final List<News> news}) = _$HomeStateImpl;
