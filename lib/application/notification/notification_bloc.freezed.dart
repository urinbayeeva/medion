...
class _$NotificationStateImpl extends _NotificationState {
  const _$NotificationStateImpl({this.isActive = false}) : super._();
  ...
  @override
  String toString() {
    return 'NotificationState(isActive: $isActive)';
  }
...
abstract class _NotificationState extends NotificationState {
  const factory _NotificationState({final bool isActive}) =
