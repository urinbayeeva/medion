  ...
  String get russianName {
    switch (this) {
      ...
      case Category.pediatricNeurologist:
        return 'Детский Невролог';
      case Category.pediatricTherapistDentist:
        return 'Детский Терапевт-Стоматолог';
