...
class CalendarDayWidget extends StatelessWidget {
                ...
                SizedBox(
                  ...
                  child: PageView.builder(
                    ...
                    onPageChanged: (pageIndex) {
                      DateTime newDate =
                          startOfWeek.add(Duration(days: 7 * (pageIndex - 0)));
                    ...
                    itemBuilder: (context, pageIndex) {
                      ...
                      return _buildWeekRow(
                          context, weekStartDate, selectedDate);
                    },
                  ),
                ),
              ],
  ...
  Widget _buildWeekRow(
      BuildContext context, DateTime weekStartDate, DateTime selectedDate) {
                ...
                children: [
                  Text(
                      ...
                      style: fonts.xSmallText.copyWith(
                          color:
                              isSelected ? colors.shade0 : colors.neutral800)),
