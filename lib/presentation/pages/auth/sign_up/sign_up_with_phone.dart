...
class SignUpWithPhone extends StatefulWidget {
  ...
  const SignUpWithPhone({super.key, this.onClose, required this.additionalPhone, this.phoneNumbers, this.phoneNumber});
      ...
      builder: (context, colors, fonts, icons, controller) {
        return BlocListener<AuthBloc, AuthState>(
          ...
          listenWhen: (previous, current) =>
              (previous.successSendCode != current.successSendCode && current.successSendCode),
          child: Scaffold(
            backgroundColor: Colors.white,
            body: Column(
              children: [
                CAppBar(leading: icons.left.svg(width: 24.w, height: 24.h), title: ''),
                16.h.verticalSpace,
                Flexible(
                  child: Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      // const Spacer(),
                      Text("enter_phone_number".tr(), style: fonts.displaySecond),
                      8.h.verticalSpace,
                      Text(
                        ...
                        child: CustomTextField(
                          ...
                          validator: (String? text) {
                            if (text != null && text.length < 17) {
                              ...
                              if (widget.phoneNumbers != null && widget.phoneNumbers!.isNotEmpty) {
                                for (var phone in widget.phoneNumbers!) {
                                  if (phone == formatPhoneNumberForUI(_phoneNumberController.text)) {
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            AnimationButtonEffect(
                              onTap: () {
                                Navigator.push(context, AppRoutes.getPrivacyPolicyPage());
                              },
                              child: RichText(
                                textAlign: TextAlign.center,
                                text: TextSpan(
                                  style: fonts.regularLink.copyWith(color: colors.primary900),
                                  children: [
                                    const TextSpan(
                                      text: 'Я согласен(а) с ',
                                    ),
