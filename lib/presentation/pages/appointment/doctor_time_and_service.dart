...
//       print('No service IDs selected');
//       _handleError('No service IDs selected');
//       return;
//     }

//     final payload = json.encode({"service_ids": selectedId});
...
//         });
//       } else {
//         print('Error response from API: ${response.body}');
...
class _DoctorTimeAndServiceState extends State<DoctorTimeAndService> {
  ...
  void _fetchServices() {
    context.read<BookingBloc>().add(
          BookingEvent.fetchThirdBookingServices(
              request: [2021, 2022, 2023, 2019]),
        );
  }
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: Column(
            children: [
              CAppBar(
                  title: state.thirdBookingServices.first.companiesDoctors!
                          .first.doctor!.first.name ??
                      "Doctor"),
