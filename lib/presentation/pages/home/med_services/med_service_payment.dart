...
//   final bool isHome;
//   final List<AppointmentItem> selectedServices;
//
//   @override
...
//                                             (appointment) {
//                                               final price = double.tryParse(appointment.price) ?? 0;
//                                               subtotal += price;
//
//                                               return Column(
//                                                 crossAxisAlignment: CrossAxisAlignment.start,
...
//                                                     ),
//                                                   ),
//                                                   if (widget.selectedServices.indexOf(appointment) !=
...
//                               Navigator.pushReplacement(context, AppRoutes.getMainPage(3));
//                             },
//                           ),
//                           8.h.verticalSpace,
//                           CButton(
...
//                                 listen: false,
//                               );
//                               if (paymentProvider.multiUrl != null && paymentProvider.multiUrl!.isNotEmpty) {
