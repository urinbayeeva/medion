...
//       return Builder(
//         builder: (context) {
//           if (widget.selectedAppointments.isEmpty) {
//             Future.microtask(() {
//               if (mounted) {
...
//                                 children: [
//                                   TextSpan(
//                                     text: 'step'.tr(namedArgs: {"count": "4", "total": "5"}),
//                                     style: fonts.xSmallLink.copyWith(
//                                         color: colors.neutral600, fontSize: 13.sp, fontWeight: FontWeight.w600),
//                                   ),
//                                   TextSpan(
//                                     text: "  ${"confirmation_of_appointment".tr()}",
//                                     style: fonts.xSmallLink.copyWith(
//                                         color: colors.primary900, fontSize: 13.sp, fontWeight: FontWeight.w600),
//                                   ),
//                                 ],
//                               ),
//                             ),
...
//                       child: Column(
//                         children: widget.selectedAppointments
...
//                         title: 'continue'.tr(),
//                         onTap: () async {
//                           if (widget.selectedAppointments.isNotEmpty) {
//                             final appointment = widget.selectedAppointments.first;
...
//                                     selectedServices: widget.selectedAppointments,
...
//   }) {
//     final parsing = DateFormat('EEE, dd MMMM', context.locale.toString()).format(DateTime.parse(appointment.date));
//
...
//       appointmentTime: '$parsing ${appointment.time}',
