      ...
      builder: (context, colors, fonts, icons, controller) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text("branches".tr(), style: fonts.regularMain),
          ),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return BranchesInfoCard(
                      yandexButton: () => launchYandexTaxi(context, branch.latitude, branch.longitude),
                      branchPhoneNumberButton: () => makePhoneCall(branch.phone!),
                      branchAdressButton: () {
                        Navigator.of(context, rootNavigator: true)
                            .push(
                              MaterialPageRoute(
                                builder: (ctx) => MapWithPolylines(
                                  destination: Point(latitude: branch.latitude, longitude: branch.longitude),
                                  name: branch.name ?? "",
